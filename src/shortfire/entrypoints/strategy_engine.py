"""FastAPI entrypoint for the strategy-engine Railway service.

Wires:
  - StrategyEngineSettings (settings load at module import — fails fast on missing env vars, FOUND-07)
...
Note: unlike data_platform, strategy-engine is ALLOWED to have MEXC_TRADE__* env vars
(declared as `mexc_trade` field on StrategyEngineSettings). No anti-leak guard here.
